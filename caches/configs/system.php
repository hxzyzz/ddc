...
'cookie_pre' => 'csGdZ_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'upload_url' => 'http://localhost/diandongche/uploadfile/', //附件路径
...
'app_path' => 'http://localhost/diandongche/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => '90CC9uPbgcgRxvLKoOVV', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://localhost/diandongche/phpsso_server',	//接口地址
'phpsso_auth_key' => 'spVLVnMVlGzAW7Axm9N0HplxRNeSc1xa', //加密密钥
