...
<form name="myform" id="myform" action="?m=admin&c=category&a=add_product" method="post">
<div class="pad-10">
<div class="col-tab">
...
<table width="100%" class="table_form ">
 <tr>
	...
	<tr>
    <?php if(($r['modelid']=="11" ||$r['modelid']=="13"||$r['modelid']=="14"||$r['modelid']=="15"||$r['modelid']=="16") && $arrpar_count==NULL && $r['parentid']==0){//增加品牌时加载厂家?>
	<tr>
        <th>所属厂家：</th>
        <td>
		<?php //echo $area_arry;?>
        <select name="info[changjia]" id="changjia">
        <option value="">请选择所属厂家</option>
		<?php
				echo $changjia_arr;
		?>
        </select>
